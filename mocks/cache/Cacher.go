...
func (_m *Cacher) Expire(ctx context.Context, key string, ttl time.Duration) (*redis.BoolCmd, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, string, time.Duration) (*redis.BoolCmd, error)); ok {
...
// GetRedisInstance provides a mock function with given fields:
func (_m *Cacher) GetRedisInstance() *redis.Client {
	ret := _m.Called()
...
func (_m *Cacher) Incr(ctx context.Context, key string) (*redis.IntCmd, error) {
	...
	var r0 *redis.IntCmd
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, string) (*redis.IntCmd, error)); ok {
		return rf(ctx, key)
	}
...
// SetNx provides a mock function with given fields: ctx, data, duration
func (_m *Cacher) SetNx(ctx context.Context, data cache.Data, duration time.Duration) (bool, error) {
	ret := _m.Called(ctx, data, duration)

	var r0 bool
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, cache.Data, time.Duration) (bool, error)); ok {
		return rf(ctx, data, duration)
	}
	if rf, ok := ret.Get(0).(func(context.Context, cache.Data, time.Duration) bool); ok {
		r0 = rf(ctx, data, duration)
	} else {
		r0 = ret.Get(0).(bool)
	}

	if rf, ok := ret.Get(1).(func(context.Context, cache.Data, time.Duration) error); ok {
		r1 = rf(ctx, data, duration)
	} else {
		r1 = ret.Error(1)
	}
