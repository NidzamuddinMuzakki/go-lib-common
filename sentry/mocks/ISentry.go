...
// NewISentry creates a new instance of ISentry. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewISentry(t testing.TB) *ISentry {
	mock := &ISentry{}
	mock.Mock.Test(t)
